                ...
                <div className="stats card l-bg-orange-dark">
                    <div className="card-statistic-3 p-4">
                        ...
                        <div className="progress mt-1" style={{ height: '8px' }}>
                            <div className="progress-bar l-bg-cyan" role="progressbar" aria-valuenow={progressValue} aria-valuemin={minProgressValue} aria-valuemax={maxProgressValue} style={{ width: `${progressValue}%` }} aria-label="packed-items-value-progress-bar"/>
                        </div>
                    </div>
                </div>
            </div>
