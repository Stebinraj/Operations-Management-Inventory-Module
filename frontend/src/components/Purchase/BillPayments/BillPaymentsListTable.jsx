                        ...
                        {billsPaymentsData.map((value, index) => {
                            return (
                                <tr key={index}>
                                    ...
                                    <td className='text-nowrap'>{`PI - ${value.paid_id}`}</td>
                                    <td className='text-nowrap'>{value.billed_id.received_order_id.purchased_id.item_id.preferred_vendor.name}</td>
                                    <td className='text-nowrap'>{value.billed_id.received_order_id.purchased_id.item_id.item_group_id.item_group_label}</td>
                                    <td className='text-nowrap'>{value.billed_id.received_order_id.purchased_id.item_id.item_name}</td>
                                    <td className='text-nowrap'>{value.billed_id.received_order_id.purchased_id.item_id.image_of_item}</td>
                                    <td className='text-nowrap'>{value.billed_id.received_order_id.purchased_id.quantity}</td>
                                    <td className='text-nowrap'>{value.billed_id.received_order_id.purchased_id.purchased_price_per_item}</td>
