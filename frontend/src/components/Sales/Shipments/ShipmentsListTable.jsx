                        ...
                        {shipmentsData.map((value, index) => {
                            return (
                                <tr key={index}>
                                    ...
                                    <td className='text-nowrap align-middle'>{value.delivery_challans_id.package_id.order_id.quantity}</td>
                                    <td className='text-nowrap align-middle'>{value.delivery_challans_id.package_id.order_id.ordered_price_per_item}</td>
                                    <td className='text-nowrap align-middle'>{value.delivery_challans_id.package_id.order_id.total}</td>
                                    <td className='text-nowrap align-middle'>
