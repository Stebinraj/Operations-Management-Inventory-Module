                        ...
                        <div className="modal-body">
                            <form className='row'>
                                <div className="mb-3 form-group col-12">
                                    <span>Name</span>
                                    <input type="text" className={name.class ? (`form-control ${name.class}`) : ('form-control')} placeholder='Enter Name' onChange={(e) => { setName({ ...name, name: e.target.value }) }} value={name.name} />
                                    {name.feedback && (
                                        <>
                                ...
                                <div className="mb-3 form-group col-12">
                                    <span>Email</span>
                                    <input type="text" className={email.class ? (`form-control ${email.class}`) : ('form-control')} placeholder='Enter Email' onChange={(e) => { setEmail({ ...email, email: e.target.value }) }} value={email.email} />
                                    {email.feedback && (
                                        <>
                                ...
                                <div className="mb-3 form-group col-12">
                                    ...
                                    <input type="text" className={phone_number.class ? (`form-control ${phone_number.class}`) : ('form-control')} placeholder='Enter Phone Number' onChange={(e) => { setPhoneNumber({ ...phone_number, phone_number: e.target.value }) }} value={phone_number.phone_number} />
                                ...
                                <div className="mb-3 form-group col-12">
                                    ...
                                    <input type="text" className={billing_address.class ? (`form-control ${billing_address.class}`) : ('form-control')} placeholder='Enter Billing Address' onChange={(e) => { setBillingAddress({ ...billing_address, billing_address: e.target.value }) }} value={billing_address.billing_address} />
